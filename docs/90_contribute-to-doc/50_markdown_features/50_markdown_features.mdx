...
```md
Let's see how to [Create a document](../20_create/20_create).
```

Let's see how to [Create a document](../20_create/20_create.md).
...
<Highlight color="#c7401e">Docusaurus green</Highlight> and <Highlight color="#1877F2">Facebook blue</Highlight> are my favorite colors.
```
...
<Highlight color="#c7401e">Docusaurus green</Highlight> and <Highlight color="#1877F2">
  Facebook blue
